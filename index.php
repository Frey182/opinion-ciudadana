            ...
            <div class="container h-100">
                ...
                <?php foreach ($temas as $tema) { ?>
                    <?php foreach ($condiciones as $condicion) { ?>
                        <?php/*  if
                            ($condicion["edad"] == $_SESSION["edad"]
                            ($condicion["sexo"] == $_SESSION["fksexo"]) &&
                            ($condicion["edad"] == $_SESSION["edad"]) &&
                            ($condicion["municipio"] == $_SESSION["municipio"]) &&
                            ($condicion["barrio"] == $_SESSION["barrio"]) &&
                            ($condicion["etnia"] == $_SESSION["etnia"]) &&
                            ($condicion["discapacidad"] == $_SESSION["discapacidad"]) &&
                            ($condicion["estrato"] == $_SESSION["estrato"]) &&
                            ($condicion["nivel_edu"] == $_SESSION["nivel_edu"]) &&
                            ($condicion["regimen"] == $_SESSION["regimen"])
                        ) {  */?>
